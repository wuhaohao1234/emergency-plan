    ...
    <div v-if="!customVisible">
      ...
      <div class="list-container">
        <el-table :data="dataList" highlight-current-row v-loading="loading" style="width: 100%;">
          <el-table-column label="文书名称" width="200" align="left" :show-overflow-tooltip="true" prop="documentName"/>
          ...
          <el-table-column label="使用单位" width="180"  :show-overflow-tooltip="true"
                           prop="applyDeptType">
            <template slot-scope="scope">
              <el-tag style="margin-right: 5px" type="primary" v-if="scope.row.useDept"
                      v-for="(item,index) in scope.row.useDeptName"
                      :key="index">{{item}}</el-tag>
            </template>
          </el-table-column>
          <el-table-column label="启用状态" width="120" header-align="center" align="center" :show-overflow-tooltip="true"
                           prop="status">
            <template slot-scope="scope">
              <el-switch
                @change="updateStatusHandle(scope.row.status,scope.row)"
          ...
          <el-table-column label="创建时间" width="150" header-align="center" align="center" :show-overflow-tooltip="true"
                           prop="createTime"/>
          ...
          <el-table-column label="操作" fixed="right" width="180" header-align="center" align="center">
            <template slot-scope="scope">
              <el-button size="mini" type="text" @click="handleUpdate(scope.row.id)">编辑</el-button>
