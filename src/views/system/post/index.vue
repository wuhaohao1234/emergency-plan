<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="postList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="岗位名称" align="left" prop="postName"   width="200" show-overflow-tooltip/>
      <el-table-column label="岗位排序" align="center" prop="orderNum" width="80" />
...
<script>
import { listPost, getPost, delPost, addPost, updatePost,pageList } from "@/api/system/post";
